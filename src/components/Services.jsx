...
const services = [
  ...
  { num: '04', title: 'השתלת עצים',    desc: 'בחירה, שתילה ועיגון נכון לכל סוג עץ, כולל ייעוץ מקצועי על מיקום ומינים.' },
  { num: '05', title: 'ניקיון גינות',   desc: 'סידור כולל של הגינה: ניקוי, גיזום שיחים, פינוי עשבייה ופסולת.' },
]
